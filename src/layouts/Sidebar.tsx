...
export function Sidebar() {
  return (
    <aside
      ...
      style={{ background: SIDEBAR_BG, borderRight: "1px solid #2a2a28" }}
    >
      <div className="flex h-12 items-center px-5" style={{ borderBottom: "1px solid #2a2a28" }}>
        <span
          className="text-sm font-bold tracking-[0.12em]"
          style={{ color: "#f0ede8", letterSpacing: "0.12em" }}
        >
          TRACKDUB
        </span>
      </div>
            ...
            {({ isActive }) => (
              <>
                <item.icon
                  ...
                  aria-hidden="true"
                  style={{ color: isActive ? ACCENT : "#5a5a52" }}
                />
                {item.name}
              </>
            )}
      ...
      <div className="px-5 py-4" style={{ borderTop: "1px solid #2a2a28" }}>
        <span className="text-[10px] font-mono tracking-widest" style={{ color: "#3a3a38" }}>
          v0.0.1
        </span>
      </div>
    </aside>
...
function JobsIcon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function BillingIcon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
